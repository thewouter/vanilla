...
<div id="DiscussionForm" class="FormTitleWrapper DiscussionForm">
    ...
    echo wrap($this->Form->textBox('Name', array('maxlength' => 100, 'class' => 'InputBox BigInput', 'value' => 'Opkomst van PERSOON')), 'div', array('class' => 'TextBoxWrapper'));
    echo '</div>';

    $this->fireEvent('BeforeBodyInput');
    echo '<div class="P">';
    echo $this->Form->bodyBox('Body', array('Table' => 'Discussion', 'FileUpload' => true, 'value' => "Dit is de opkomst van PERSOON, geef even aan of je komt."));
